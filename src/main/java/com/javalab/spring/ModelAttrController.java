...
@Slf4j	// 롬복에서 제공해주는 로깅 유틸 사용(스프링꺼 안씀)
public class ModelAttrController {

	/*
	 * [@ModelAttribute]
	 * @ModelAttribute 어노테이션이 붙어 있는 메소드가 있으면
	 * @RequestMapping 이 붙은 어떤 메소드보다 우선해서 실행되고 난 후에
	 * 			실제로 호출된 메소드가 실행된다.
	 * @ModelAttribute를 사용한 Method에서 객체를 return 하면
	 * Model에 자동적으로 담아준다.
	 * @ModelAttribute("modelVo") : jsp에서 "modelVo라는
	 * 이름으로 사용
	...
	public Map<String, Object> callFirstofAll(){
		...
		Map<String, Object> modelVo = new HashMap<String, Object>();
	...
	public String modelForm(Model model) {
		...
		// input text/radio/checkbok 등에 값 세팅
